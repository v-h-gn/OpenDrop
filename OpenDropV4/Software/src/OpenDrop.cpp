...
void pinStr(uint32_t ulPin, unsigned strength) // works like pinMode(), but to set drive strength
{
  ...
  if (strength)
    strength = 1; // set drive strength to either 0 or 1 copied
...

{
  ...
  for (int x = 0; x < (FluxlPad_width); x++)
    for (int y = 0; y < FluxlPad_heigth; y++)
      if (Fluxls[x][y])
      {
        ...
        {
          if (y == 0)
            display.drawRect(x * 6 + 17, 6 + 16, 5, 5, 1); // Entrance
          if (y == 1)
          {
            display.drawRect(14, 16, 5, 5, 1);
            display.drawRect(14, 28, 5, 5, 1);
          } // Side Pads
          if (y == 2)
            display.drawRect(9, 22, 7, 5, 1); // Long Pad
          if (y == 3)
          {
            display.drawRect(7, 16, 6, 5, 1);
            display.drawRect(7, 28, 6, 5, 1);
            display.drawRect(3, 16, 5, 17, 1);
          } // Reservoir

          if (y == 4)
          {
            display.drawRect(7, 46, 6, 5, 1);
            display.drawRect(7, 46 + 12, 6, 5, 1);
            display.drawRect(3, 46, 5, 17, 1);
          }
          if (y == 5)
            display.drawRect(9, 46 + 6, 7, 5, 1);
          if (y == 6)
          {
            display.drawRect(14, 46, 5, 5, 1);
            display.drawRect(14, 46 + 12, 5, 5, 1);
          }
          if (y == 7)
            display.drawRect(x * 6 + 17, 36 + 16, 5, 5, 1);
        }
        else if (x == 15)
        {
          if (y == 0)
            display.drawRect(x * 6 + 17, 6 + 16, 5, 5, 1);
          if (y == 1)
          {
            display.drawRect(110, 16, 5, 5, 1);
            display.drawRect(110, 28, 5, 5, 1);
          }
          if (y == 2)
            display.drawRect(113, 22, 7, 5, 1);
          if (y == 3)
          {
            display.drawRect(116, 16, 6, 5, 1);
            display.drawRect(116, 28, 6, 5, 1);
            display.drawRect(121, 16, 5, 17, 1);
          }

          if (y == 4)
          {
            display.drawRect(116, 46, 6, 5, 1);
            display.drawRect(116, 46 + 12, 6, 5, 1);
            display.drawRect(121, 46, 5, 17, 1);
          }
          if (y == 5)
            display.drawRect(113, 46 + 6, 7, 5, 1);
          if (y == 6)
          {
            display.drawRect(110, 46, 5, 5, 1);
            display.drawRect(110, 46 + 12, 5, 5, 1);
          }
          if (y == 7)
            display.drawRect(x * 6 + 17, 36 + 16, 5, 5, 1);
        }
    ...
    for (int x = 0; x < (FluxlPad_width); x++)
      for (int y = 0; y < FluxlPad_heigth; y++)
        if (Fluxls_feedback[x][y])
        {
          ...
          {
            if (y == 0)
              display.drawRect(x * 6 + 18, 6 + 17, 3, 3, 1); // Entrance
            if (y == 1)
            {
              display.drawRect(15, 17, 3, 3, 1);
              display.drawRect(15, 29, 3, 3, 1);
            } // Side Pads
            if (y == 2)
              display.drawRect(10, 23, 5, 3, 1); // Long Pad
            if (y == 3)
            {
              display.drawRect(8, 17, 4, 3, 1);
              display.drawRect(8, 29, 4, 3, 1);
              display.drawRect(4, 17, 3, 15, 1);
            } // Reservoir

            if (y == 4)
            {
              display.drawRect(8, 47, 4, 3, 1);
              display.drawRect(8, 46 + 13, 4, 3, 1);
              display.drawRect(4, 47, 3, 15, 1);
            }
            if (y == 5)
              display.drawRect(10, 46 + 7, 5, 3, 1);
            if (y == 6)
            {
              display.drawRect(15, 47, 3, 3, 1);
              display.drawRect(15, 46 + 13, 3, 3, 1);
            }
            if (y == 7)
              display.drawRect(x * 6 + 17, 36 + 16, 5, 5, 1);
          }
          ...
          {
            if (y == 0)
              display.drawRect(x * 6 + 18, 6 + 17, 3, 3, 1);
            if (y == 1)
            {
              display.drawRect(111, 17, 3, 3, 1);
              display.drawRect(111, 29, 3, 3, 1);
            }
            if (y == 2)
              display.drawRect(114, 23, 5, 3, 1);
            if (y == 3)
            {
              display.drawRect(117, 17, 4, 3, 1);
              display.drawRect(117, 29, 4, 3, 1);
              display.drawRect(122, 17, 3, 15, 1);
            }

            if (y == 4)
            {
              display.drawRect(117, 47, 4, 3, 1);
              display.drawRect(117, 46 + 13, 4, 3, 1);
              display.drawRect(122, 47, 3, 15, 1);
            }
            if (y == 5)
              display.drawRect(114, 46 + 7, 5, 3, 1);
            if (y == 6)
            {
              display.drawRect(111, 47, 3, 3, 1);
              display.drawRect(111, 46 + 13, 3, 3, 1);
            }
            if (y == 7)
              display.drawRect(x * 6 + 18, 36 + 17, 3, 3, 1);
          }
          else
  ...
  // Volatge Check
  if (abs(VOLTAGE_value - Voltage_set) < Volateg_tollerance)
    HV_set_ok = true;
  if (analogRead(V_USB_pin) < 800)
    HV_set_ok = false;
...
bool OpenDrop::run(void)
{
  ...
  for (int i = 0; i < this->drop_count; i++)
  {
    ...
    // sets _runing to either true or false base on if the drop is at its goal
